# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2016-11-18 01:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_by', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='GroupMembers',
        ...
        migrations.AddField(
            model_name='group',
            name='current_leader',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, related_name='leader', to='groups.GroupMembers'),
        ),
